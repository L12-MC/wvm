...
REM Release URLs
set "WSLANG_URL=https://github.com/L12-MC/wslang/releases/download/v1.0.3/ws-windows.exe"
set "WPM_URL=https://github.com/L12-MC/wpm/releases/download/v2.0/wpm.exe"
